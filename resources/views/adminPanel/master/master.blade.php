...
<head>
    ...
    <link rel="stylesheet" href="/admin/font/iconsmind-s/css/iconsminds.css" />
...
{{--    <link rel="stylesheet" href="/admin/DropZone-min/dropzone.min.css" />--}}
    ...
    <link rel="stylesheet" href="/admin/css/vendor/select2-bootstrap.min.css" />
    <link rel="stylesheet" href="/admin/css/vendor/bootstrap-datepicker3.min.css" />
    <link rel="stylesheet" href="/admin/css/vendor/bootstrap-tagsinput.css" />
    <link rel="stylesheet" href="/admin/css/vendor/component-custom-switch.min.css" />
    <link rel="stylesheet" href="/admin/css/vendor/perfect-scrollbar.css" />
                ...
                <div class="dropdown-menu dropdown-menu-right mt-3 position-absolute" id="notificationDropdown">
                    <div class="scroll">
                        <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                            <a href="#">
                                <img src="/admin/img/profiles/l-2.jpg" alt="Notification Image"
                        ...
                        <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                            <a href="#">
                                <img src="/admin/img/notifications/1.jpg" alt="Notification Image"
                                     class="img-thumbnail list-thumbnail xsmall border-0 rounded-circle" />
                            </a>
                            <div class="pl-3">
                                <a href="#">
                        ...
                        <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                            <a href="#">
                                <img src="/admin/img/notifications/2.jpg" alt="Notification Image"
                                     class="img-thumbnail list-thumbnail xsmall border-0 rounded-circle" />
                            </a>
                            <div class="pl-3">
                                <a href="#">
                        ...
                        <div class="d-flex flex-row mb-3 pb-3 ">
                            <a href="#">
                                <img src="/admin/img/notifications/3.jpg" alt="Notification Image"
                                     class="img-thumbnail list-thumbnail xsmall border-0 rounded-circle" />
                            </a>
                            <div class="pl-3">
                                <a href="#">
...
{{--@include('adminPanel.master.partial.menu')--}}
